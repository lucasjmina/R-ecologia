...
En esta guía se veran distintas pruebas de hipótesis estadisticas, tanto parametricas como no parametricas. Se utilizará el set de hormigas `hormigas.csv`, `moscas.csv`, `abundancia.csv` y `ambiente.csv`
