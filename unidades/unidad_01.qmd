...
En esta guía veremos como calcular distintos índices de diversidad alfa cómo Shannon, Simpson y diversidad verdadera. Así como estimadores: Chao, Jacknife, ACE e ICE. Se utilizaran los set de datos llamados `abundancia_tratamiento.csv` y `abundancia_conservacion_larga.csv`
...
abund_ec <- read.csv("datos/abundancia_conservacion_larga.csv", header = TRUE, row.names = 1)
